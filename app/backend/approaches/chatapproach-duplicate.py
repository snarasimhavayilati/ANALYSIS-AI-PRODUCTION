...
class ChatApproach(Approach, ABC):
    ...
    query_prompt_few_shots = [
        ...
        {"role": ASSISTANT, "content": "Summarize the Bank Secrecy Act and reference the actual regulation, before referencing handbooks or manuals"},
        {"role": USER, "content": "What is required for a Community Reinvestment Act audit?"},
        {"role": ASSISTANT, "content": "Show the main topics covered in a Community Reinvestment Act audit and prioritize manuals and handbooks as primary sources, only use regulations as secondary sources of content"},
        ...
        {"role": ASSISTANT, "content": "Explain the main differences between US banking Regulation O and Regulation W.  Prioritize using regulations to answer and only use manuals and handbooks as secondary sources?"},
        {"role": USER, "content": "What are the key provisions of the Truth in Lending Act (TILA)?"},
        {"role": ASSISTANT, "content": "Show the main topics within the Truth in Lending Act (TILA). Prioritize using regulations in your answer and only use manuals and handbooks as secondary sources"},
    ]
    NO_RESPONSE = "0"
